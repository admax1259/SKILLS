...
The HTML report template uses a Mermaid CDN and requires network access. Escape repository text inserted into HTML and keep Mermaid security mode strict. Provide a readable text fallback when the CDN is unavailable.
