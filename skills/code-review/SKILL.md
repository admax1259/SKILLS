...
1. Issue and review references in the commit messages (`#123`, `Closes #45`, or GitLab MR `!67`; GitLab issues use `#67`), fetched via the workflow in `docs/agents/issue-tracker.md`.
