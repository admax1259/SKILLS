...
**Image mode — emission is allowed by default.** An attachment does not prove ownership of its contents. Emit only the requested abstract design analysis; preserve attribution and do not copy protected assets or text.
