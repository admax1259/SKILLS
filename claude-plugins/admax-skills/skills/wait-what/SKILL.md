...
Wait, I don't understand where you've got to here. Re-pitch that: give me a little bit of context, use plain language in the user’s preferred language, and use the ubiquitous language from `CONTEXT.md` (follow `CONTEXT-MAP.md` to the right one if the repo has more than one).
